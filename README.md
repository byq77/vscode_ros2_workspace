...
This template is a complete setup for developing ROS2 kilted packages with [Visual Studio Code](https://code.visualstudio.com/) and [the Remote Containers extension](https://marketplace.visualstudio.com/items?itemName=ms-vscode-remote.remote-containers) on Ubuntu.
...
- `osrf/ros:kilted-desktop-full` as the base image,
